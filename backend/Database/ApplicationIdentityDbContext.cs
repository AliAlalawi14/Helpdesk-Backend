...
// Stock Identity now. Everything that used to hang off the identity user — Name,
// IsActive, CreatedAt, the role — moved to the domain User in the app schema.
// This context holds credentials and refresh tokens, nothing else.
    ...
    : IdentityDbContext<IdentityUser, IdentityRole, string>(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<IdentityUser>(entity =>
            entity.Property(u => u.Id).HasMaxLength(500));
